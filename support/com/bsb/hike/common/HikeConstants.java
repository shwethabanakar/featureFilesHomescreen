...
public class HikeConstants
{
    ...
    public static final String HTTP_RC_CONFIG = "httprcconfig";
    ...
    public static final String HIKE_BOT_MSISDN = "+hike+";
    ...
    public static final long MILLISECONDS_IN_A_MONTH = 30 * 7 * 24 * 60 * 60 * 1000;
